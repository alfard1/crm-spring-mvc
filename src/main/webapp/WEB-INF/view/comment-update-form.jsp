...
<body>
	...
	<div id="container" style="margin-top: 50px; margin-left: 20px; margin-right: 20px;" class="col-md-auto">
		...
		<form:form method="POST" action="saveUpdatedComment"
			...
			<div>
				<div>
					<div>
						...
						<c:if test="${updatedCommentError != null}">
							<div class="alert alert-danger" role="alert">
								${updatedCommentError}</div>
						</c:if>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label for="commentDesc">Your comment to the selected
					product (*):</label>
				<form:input path="commentDesc" class="form-control" id="commentDesc"
					rows="3" />
