...
<head>
	<title>Save Product | Spring CRM</title>
	<meta charset="utf-8">
    		...
    		<ul class="navbar-nav mr-auto">
				<li class="nav-item">
      			...
      			<li class="nav-item active">
        			<a class="nav-link" href="${pageContext.request.contextPath}/product/list">Products<span class="sr-only">(current)</span></a>
      			</li>
      			<li class="nav-item">
	...
	<div id="container" style="margin-top: 50px; margin-left: 20px; margin-right: 20px;" class="col-md-auto">
		...
		<form:form action="saveProduct" modelAttribute="product">
					    ...
					    <div>
					        <div >
					            <div>
									...
									<c:if test="${newProductError != null}">
			...
			<div class="form-group">
				<label>Name (*):</label>
				<form:input path="name" class="form-control" rows="3" />
