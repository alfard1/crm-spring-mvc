...
<head>
	<title>Customers | Spring CRM</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="content">
		...
		<security:authorize access="hasAnyRole('MANAGER', 'ADMIN')">
			<div class="add-object">			
				<input type="button" value="Add Customer" onclick="window.location.href='showFormForAdd'; return false;" class="btn btn-primary" />
			</div>	
		</security:authorize>
	...
	<div class="legend-with-padding">
		<div class="legend-background">
			<div class="legend">					
				<p>Permissions for managing customers:</p>
				<ul>
					  <li>employee - view</li>
